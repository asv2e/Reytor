...
final class BrowserPreferences {
    ...
    func registerDefaults() {
        ...
        UserDefaults.standard.register(defaults: [
            ...
            key("FingerprintingProtection", "enabled"): false,
            key("FingerprintingProtection", "letterboxingEnabled"): true,
            key("FingerprintingProtection", "blocksWebRTC"): true,
            ...
            // JavaScript
            key("JavaScript", "blocksByDefault"): false,
            
            // Anti-XSS
            key("AntiXSS", "enabled"): true,
            
            // Website Isolation
            key("WebsiteIsolation", "enabled"): false,
            
            // Amnesic Mode
            key("Amnesic", "enabled"): false,
        ])
    }
    ...
    struct FingerprintingProtectionPreferences {
        static var enabled: Bool {
            get { return prefs.bool(forSetting: "FingerprintingProtection", key: "enabled") }
            set { prefs.set(newValue, forSetting: "FingerprintingProtection", key: "enabled") }
        }
        
        static var letterboxingEnabled: Bool {
            get { return prefs.bool(forSetting: "FingerprintingProtection", key: "letterboxingEnabled") }
            set { prefs.set(newValue, forSetting: "FingerprintingProtection", key: "letterboxingEnabled") }
        }
        
        static var blocksWebRTC: Bool {
            get { return prefs.bool(forSetting: "FingerprintingProtection", key: "blocksWebRTC") }
            set { prefs.set(newValue, forSetting: "FingerprintingProtection", key: "blocksWebRTC") }
        }
        
        static var spoofsAcceptLanguage: Bool {
            get { return prefs.bool(forSetting: "FingerprintingProtection", key: "spoofsAcceptLanguage") }
            set { prefs.set(newValue, forSetting: "FingerprintingProtection", key: "spoofsAcceptLanguage") }
        }
    }
    
    // MARK: - Security Level
    struct SecurityLevelPreferences {
        static var level: SecurityLevel {
            get {
                let rawValue = prefs.string(forSetting: "SecurityLevel", key: "level") ?? SecurityLevel.standard.rawValue
                return SecurityLevel(rawValue: rawValue) ?? .standard
            }
            set { prefs.set(newValue.rawValue, forSetting: "SecurityLevel", key: "level") }
        }
    }
    ...
    struct TorPreferences {
        ...
        // separated, same format as Tor Browser's bridge entry field.
        static var usesBridges: Bool {
            get { return prefs.bool(forSetting: "Tor", key: "usesBridges") }
            set { prefs.set(newValue, forSetting: "Tor", key: "usesBridges") }
        }
        
        static var bridgeLines: String {
            get { return prefs.string(forSetting: "Tor", key: "bridgeLines") ?? "" }
            set { prefs.set(newValue, forSetting: "Tor", key: "bridgeLines") }
        }
    }
    
    // MARK: - JavaScript (NoScript-style)
    struct JavaScriptPreferences {
        // Global default used for any site without its own override in
        // SiteSettingsStore. false (JavaScript allowed) matches ordinary
        // browser behavior; NoScript-style users can flip this so every
        // site is blocked unless explicitly allowed per-site instead.
        static var blocksByDefault: Bool {
            get { return prefs.bool(forSetting: "JavaScript", key: "blocksByDefault") }
            set { prefs.set(newValue, forSetting: "JavaScript", key: "blocksByDefault") }
        }
    }
    
    // MARK: - Anti-XSS
    struct AntiXSSPreferences {
        static var enabled: Bool {
            get { return prefs.bool(forSetting: "AntiXSS", key: "enabled") }
            set { prefs.set(newValue, forSetting: "AntiXSS", key: "enabled") }
        }
    }
    
    // MARK: - Website Isolation
    struct WebsiteIsolationPreferences {
        static var enabled: Bool {
            get { return prefs.bool(forSetting: "WebsiteIsolation", key: "enabled") }
            set { prefs.set(newValue, forSetting: "WebsiteIsolation", key: "enabled") }
        }
    }
    
    // MARK: - Amnesic Mode
    struct AmnesicPreferences {
        // When on, every tab is created as a Gecko Private Browsing
        // session (see SessionManager.createSession) and the tab list
        // itself is never written to disk (see TabManagerImpl.persistState)
        // - nothing about the browsing session survives the app closing.
        static var enabled: Bool {
            get { return prefs.bool(forSetting: "Amnesic", key: "enabled") }
            set { prefs.set(newValue, forSetting: "Amnesic", key: "enabled") }
        }
    }
    ...
    struct AppearanceSettings {
        ...
        static var useAlternateAppIcon: Bool {
            get {
                prefs.bool(forSetting: "AppearanceSettings", key: "useAlternateAppIcon")
            }
            set {
                prefs.set(newValue, forSetting: "AppearanceSettings", key: "useAlternateAppIcon")
            }
        }
