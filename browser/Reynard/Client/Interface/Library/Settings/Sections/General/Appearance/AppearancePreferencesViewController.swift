...
final class AppearancePreferencesViewController: SettingsTableViewController {
    ...
    private let alternateAppIconSwitch = UISwitch()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .alternateAppIcon:
            ...
            cell.textLabel?.text = NSLocalizedString("Use Alternate App Icon", comment: "")
            cell.selectionStyle = .none
            cell.accessoryView = alternateAppIconSwitch
            return cell
        case .BrowserChromePosition:
    ...
    private func configureSwitch() {
        alternateAppIconSwitch.addTarget(self, action: #selector(alternateAppIconSwitchDidChange), for: .valueChanged)
    ...
    private func refreshDisplayedState() {
        alternateAppIconSwitch.isOn = Prefs.AppearanceSettings.useAlternateAppIcon
    ...
    @objc private func alternateAppIconSwitchDidChange() {
        Prefs.AppearanceSettings.useAlternateAppIcon = alternateAppIconSwitch.isOn
        AppAppearanceController.setAppIcon(alternateAppIconSwitch.isOn)
    }
    ...
    private func rows(
        ...
        case .appAppearance:
            if UIApplication.shared.supportsAlternateIcons {
                return [.appAppearance, .alternateAppIcon]
            }
